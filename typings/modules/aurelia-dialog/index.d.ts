...
export function validateBehaviorName(name: string, type: string): any;
...
*/
export function getDecoratorDependencies(target: any): any;
/**
...
*/
export function factory(keyValue: any): (target: any, key: any, index: any) => void;
/**
